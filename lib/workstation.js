		...
		ast: function() {
			return {
				addScreen: function(title) {
					...
					screenObj.addWidget = function(args, type) {
...
function screen(title, block) {
	workstation.ast().addScreen(title);
...
function label(args) {
	...
	workstation.ast().lastScreen().addWidget(args, "label")	
}

function textbox(args) {
	workstation.ast().lastScreen().addWidget(args, "textbox");
}

function button(args) {
	workstation.ast().lastScreen().addWidget(args, "button");
}
